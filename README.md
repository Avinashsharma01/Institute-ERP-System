# 📚 EduMatrix  - Complete Learning Management System
...
**EduMatrix ** is a comprehensive Learning Management System (LMS) designed to bridge the gap between traditional classroom teaching and modern digital education. Built for coaching institutes, schools, and educational organizations, it provides a seamless experience for students, teachers, and administrators.
...
```bash
git clone https://github.com/Ideovent-Technologies/EduMatrix-Classes.git
cd EduMatrix-Classes
```
...
```env
# Database
MONGO_URI=mongodb://localhost:27017/EduMatrix-classes
...
-   **Email**: admin@EduMatrixclasses.com
-   **Password**: Admin@123
...
EduMatrix  supports various educational programs:
...
-   **Email**: support@EduMatrixclasses.com
...
-   [Frontend Documentation](./EduMatrix-Classes/README.md)
